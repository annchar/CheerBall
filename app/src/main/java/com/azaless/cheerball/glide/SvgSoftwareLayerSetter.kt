...
class SvgSoftwareLayerSetter : RequestListener<PictureDrawable> {
	...
	override fun onResourceReady(resource: PictureDrawable?, model: Any?, target: com.bumptech.glide.request.target.Target<PictureDrawable>?, dataSource: DataSource?, isFirstResource: Boolean): Boolean {
		val view = (target as ImageViewTarget<*>).view
